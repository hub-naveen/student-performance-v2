...
def generate_random_names():
    ...
    # Save to CSV
    names_df.to_csv('student_names_generated.csv', index=False)
    ...
    # Save merged dataset
    merged_df.to_csv('StudentPerformance_with_names.csv', index=False)
    print(f"\nMerged dataset saved as 'StudentPerformance_with_names.csv'")
    print(f"Names only saved as 'student_names_generated.csv'")
